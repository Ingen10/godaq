...
func TestToVoltsSigned(t *testing.T) {
	...
	// gain x1
	assert.Equal(t, -4.096, adc.ToVolts(-2048, 0, Calib{1, 0}))
	assert.Equal(t, 0.0, adc.ToVolts(0, 0, Calib{1, 0}))
	assert.Equal(t, 4.096, adc.ToVolts(2048, 0, Calib{1, 0}))

	// gain x4
	assert.Equal(t, -1.024, adc.ToVolts(-2048, 2, Calib{1, 0}))
	assert.Equal(t, 0.0, adc.ToVolts(0, 2, Calib{1, 0}))
	assert.Equal(t, 1.024, adc.ToVolts(2048, 2, Calib{1, 0}))
}
...
func TestToVoltsUnSigned(t *testing.T) {
	...
	// gain x1
	assert.Equal(t, -4.096, adc.ToVolts(0, 0, Calib{1, 0}))
	assert.Equal(t, 0.0, adc.ToVolts(2048, 0, Calib{1, 0}))
	assert.Equal(t, 4.096, adc.ToVolts(4096, 0, Calib{1, 0}))

	// gain x4
	assert.Equal(t, -1.024, adc.ToVolts(0, 2, Calib{1, 0}))
	assert.Equal(t, 0.0, adc.ToVolts(2048, 2, Calib{1, 0}))
	assert.Equal(t, 1.024, adc.ToVolts(4096, 2, Calib{1, 0}))
}
